...
read_csv("D:\\Documents\\R directory\\labor market\\nfp_revisions.csv") %>% 
  ...
  mutate(date_released = case_when(estimate == "1st" ~ month,
         ...
         rank_index = dense_rank(index) - 34, # edit this number to get rank_index to start at 1
...
chart1 <- chrt_dat_lng %>% 
  ...
  scale_x_date(breaks = c(as.Date("2019-01-01"), as.Date("2020-01-01"), as.Date("2021-01-01"), as.Date("2022-01-01"), as.Date("2023-01-01")),
               date_labels = "'%y") +
